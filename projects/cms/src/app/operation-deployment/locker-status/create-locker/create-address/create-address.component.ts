...
import { AddressService } from '../../../../system-setting/address/address.service';
import { StoreService } from '../../../../warehouse/store/store.service';
import { BehaviorSubject } from 'rxjs';

@Component({
  selector: 'cms-create-address',
  templateUrl: './create-address.component.html',
  styleUrls: ['./create-address.component.less'],
})
export class CreateAddressComponent implements OnInit {
  ...
  listOfWard: any[];
  listOfBuidClass: any[];
  private itemAddress = new BehaviorSubject<number>(null);

  getItemAddress(item) {
    this.itemAddress.next(item);
  }
  setItemAddress() {
    return this.itemAddress.asObservable();
  }
